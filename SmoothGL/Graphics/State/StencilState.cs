...
namespace SmoothGL.Graphics
{
    ...
    public class StencilState : IGraphicsState
    {
        ...
        /// </summary>
        public static readonly StencilState None = new StencilState(false, null, null, 0, 0, 0);
        ...
        /// </summary>
        public StencilFaceState StencilFrontState { get; private set; }

        /// <summary>
        /// Gets the operations which are performed for back faces dependent on the result of the stencil test.
        /// </summary>
        public StencilFaceState StencilBackState { get; private set; }
        ...
        /// </summary>
        public int StencilReadMask { get; private set; }

        /// <summary>
        /// Gets a bit mask defining which bits are written to the stencil buffer.
        /// </summary>
        public int StencilWriteMask { get; private set; }

        /// <summary>
        /// Creates a new stencil state object.
        /// </summary>
        /// <param name="stencilTestEnabled">indicates whether stencil testing is enabled.</param>
        /// <param name="stencilFrontState">Operations which are performed for front faces dependent on the result of the stencil test.</param>
        /// <param name="stencilBackState">Operations which are performed for back faces dependent on the result of the stencil test.</param>
        /// <param name="referenceStencil">reference stencil value, which is written to the stencil buffer when performing <see cref="StencilOperation.Replace"/>.</param>
