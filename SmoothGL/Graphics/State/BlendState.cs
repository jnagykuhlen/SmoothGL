...
namespace SmoothGL.Graphics
{
    ...
    public class BlendState : IGraphicsState
    {
        ...
        /// </summary>
        public static readonly BlendState AlphaNonPremultiplied = new BlendState(
            BlendEquation.Add,
            BlendEquation.Add,
            Blend.SourceAlpha,
        ...
        /// </summary>
        public static readonly BlendState AlphaPremultiplied = new BlendState(
            BlendEquation.Add,
            BlendEquation.Add,
            Blend.One,
            Blend.SourceAlphaInverse,
        ...
        /// </summary>
        public static readonly BlendState None = new BlendState(
            BlendEquation.Add,
            BlendEquation.Add,
            Blend.One,
            Blend.One,
        ...
        /// <param name="colorWriteChannels">The color channels in the current frame buffer which are affected by blending operations.</param>
