...
namespace SmoothGL.Graphics
{
    ...
    public class TextureFilterMode
    {
        ...
        /// </summary>
        public static readonly TextureFilterMode Default = new TextureFilterMode(TextureInterpolation.Linear, 1.0f, true);

        /// <summary>
        /// Filter mode that does not apply any filtering when sampling a texture.
        /// </summary>
        public static readonly TextureFilterMode None = new TextureFilterMode(TextureInterpolation.Nearest, 1.0f, false);
