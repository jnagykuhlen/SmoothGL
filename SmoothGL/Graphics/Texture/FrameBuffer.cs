...
namespace SmoothGL.Graphics
{
    ...
    public class FrameBuffer : FrameBufferTarget
    {
        ...
        /// </summary>
        /// <param name="depthStencilAttachment">Attachment used for depth and stencil testing.
        /// This parameter can be null in case that depth and stencil testing are not required.</param>
        ...
        {
            int maxDrawBuffers = GL.GetInteger(GetPName.MaxDrawBuffers);
            int maxColorAttachments = GL.GetInteger(GetPName.MaxColorAttachments);
            ...
            FrameBufferTarget lastTarget = Current;
            Bind();
