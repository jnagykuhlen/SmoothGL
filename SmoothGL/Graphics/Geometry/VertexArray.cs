...
namespace SmoothGL.Graphics
{
    ...
    public class VertexArray : GraphicsResource
    {
        ...
        private static int _currentVertexArrayId = 0;
        ...
        /// <summary>
        /// Creates a new vertex array referencing the specified vertex buffer and an additional buffer holding per-instance data.
        /// </summary>
        /// <param name="vertexBuffer">Referenced vertex buffer.</param>
        /// <param name="instanceBuffer">Referenced buffer holding per-instance data.</param>
        ...
        /// <summary>
        /// Creates a new vertex array referencing the specified vertex buffers and an additional buffer holding per-instance data.
        /// </summary>
        /// <param name="vertexBuffers">Referenced vertex buffers.</param>
        /// <param name="instanceBuffer">Referenced buffer holding per-instance data.</param>
        ...
        /// <summary>
        /// Creates a new vertex array referencing the specified vertex buffers and additional buffers holding per-instance data.
        /// </summary>
        /// <param name="vertexBuffers">Referenced vertex buffers.</param>
            ...
            : this()
        {
            ...
            foreach (VertexBuffer instanceBuffer in instanceBuffers)
